...
public class MainActivity extends AppCompatActivity {
	...
	private LinearLayout _drawer_linear_info_block;
	private LinearLayout _drawer_linear_footer;
	private ImageView _drawer_imageview7;
	private ScrollView _drawer_vscroll_contact_info;
	...
	private Intent audio = new Intent();
	private Intent chat = new Intent();
	private Intent twitter = new Intent();
	private Intent fb = new Intent();
	private Intent plus = new Intent();
	private AlertDialog.Builder facebook;
	private AlertDialog.Builder mail;
	private AlertDialog.Builder phone;
	private AlertDialog.Builder maps;
	...
	private Intent webinar = new Intent();
	@Override
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		_drawer_linear_info_block = (LinearLayout) _nav_view.findViewById(R.id.linear_info_block);
		...
		_drawer_vscroll_contact_info = (ScrollView) _nav_view.findViewById(R.id.vscroll_contact_info);
		...
		mail = new AlertDialog.Builder(this);
		phone = new AlertDialog.Builder(this);
		maps = new AlertDialog.Builder(this);
		donation = new AlertDialog.Builder(this);
		Exit = new AlertDialog.Builder(this);
		
		twitter_member_1.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				//open twitter
				twitter.setAction(Intent.ACTION_VIEW);
				twitter.setData(Uri.parse(""));
				startActivity(twitter);
			}
		});
		
		facebook_member_1.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				//Open facebook
		...
		plus_member_1.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				//Open plus
				plus.setAction(Intent.ACTION_VIEW);
				plus.setData(Uri.parse(""));
				startActivity(plus);
			}
		});
		...
		_drawer_linear_telephone.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				//call telephone on click
				phone.setTitle("Warning!");
				phone.setMessage("Call Jubilee?");
				phone.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
					@Override
				...
				phone.setNegativeButton("No", new DialogInterface.OnClickListener() {
					@Override
					public void onClick(DialogInterface _dialog, int _which) {
						finish();
					}
		...
		_drawer_linear_email.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				//email on click
				mail.setTitle("Warning!");
				mail.setMessage("Open in Email?");
				mail.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
					@Override
					public void onClick(DialogInterface _dialog, int _which) {
						email.setAction(Intent.ACTION_VIEW);
						email.setData(Uri.parse("mailto:info@jubilee.co.za"));
						email.putExtra("subject", "write a topic");
						email.putExtra("message", "write your message");
						startActivity(email);
					}
				});
				mail.setNegativeButton("No", new DialogInterface.OnClickListener() {
					@Override
					public void onClick(DialogInterface _dialog, int _which) {
						finish();
					}
		...
		_drawer_linear_location.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				//Open maps on click
				maps.setTitle("Warning!");
				maps.setMessage("Open Google Maps?");
				maps.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
					@Override
					public void onClick(DialogInterface _dialog, int _which) {
						SketchwareUtil.showMessage(getApplicationContext(), "Open in Maps!");
					}
				});
				maps.setNegativeButton("No", new DialogInterface.OnClickListener() {
					@Override
					public void onClick(DialogInterface _dialog, int _which) {
						finish();
					}
		...
		_drawer_linear_donations.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				//open in_app purchases on click
				donation.setTitle("Warning!");
				donation.setMessage("Donate to Jubilee?");
				donation.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
					@Override
					public void onClick(DialogInterface _dialog, int _which) {
						SketchwareUtil.showMessage(getApplicationContext(), "Opening in-app purchasing!");
					}
				});
				donation.setNegativeButton("No", new DialogInterface.OnClickListener() {
					@Override
					public void onClick(DialogInterface _dialog, int _which) {
...
*/
		...
		while(true) {
			...
			//Setup 3d
			_set3d(linear2, 35);
			_roundImageView(imageview2, 50);
			_set3d(imageview2, 50);
			_roundImageView(imageview3, 50);
			_set3d(imageview3, 50);
			_roundImageView(imageview4, 50);
			_set3d(imageview4, 50);
			_roundImageView(imageview5, 50);
			_set3d(imageview5, 50);
					...
					runOnUiThread(new Runnable() {
						...
						public void run() {
							...
							if (count == 1) {
								...
								_roundImageView(imageview1, 25);
								_setCornerRadius(linear4, 360, "#3F51B5");
								_setCornerRadius(linear5, 360, "#616161");
								_setCornerRadius(linear6, 360, "#616161");
								_setCornerRadius(linear7, 360, "#616161");
								_setCornerRadius(linear8, 360, "#616161");
								_set3d(imageview1, 50);
								imageview1.setBackgroundColor(0xFFBA68C8);
							}
							if (count == 2) {
								imageview1.setImageResource(R.drawable.ravensmead);
								_roundImageView(imageview1, 25);
								_setCornerRadius(linear4, 360, "#616161");
								_setCornerRadius(linear5, 360, "#3F51B5");
								_setCornerRadius(linear6, 360, "#616161");
								_setCornerRadius(linear7, 360, "#616161");
								_setCornerRadius(linear8, 360, "#616161");
								_set3d(imageview1, 50);
							...
							if (count == 3) {
								...
								_setCornerRadius(linear4, 360, "#616161");
								_setCornerRadius(linear5, 360, "#616161");
								_setCornerRadius(linear6, 360, "#3F51B5");
								_setCornerRadius(linear7, 360, "#616161");
								_setCornerRadius(linear8, 360, "#616161");
								_set3d(imageview1, 50);
								imageview1.setBackgroundColor(0xFFBA68C8);
							...
							if (count == 4) {
								...
								_setCornerRadius(linear5, 360, "#616161");
								_setCornerRadius(linear6, 360, "#616161");
								_setCornerRadius(linear7, 360, "#3F51B5");
								_setCornerRadius(linear8, 360, "#616161");
								_set3d(imageview1, 50);
								imageview1.setBackgroundColor(0xFFBA68C8);
							}
							if (count == 5) {
								...
								_setCornerRadius(linear6, 360, "#616161");
								_setCornerRadius(linear7, 360, "#616161");
								_setCornerRadius(linear8, 360, "#3F51B5");
								_set3d(imageview1, 50);
								imageview1.setBackgroundColor(0xFFBA68C8);
							}
							if (count == 6) {
	...
	private void _success_dialog () {
		final AlertDialog success_dialog = new AlertDialog.Builder(MainActivity.this).create();
		...
		Button s_ok = (Button) convertView.findViewById(R.id.success_okay_button);
		...
		s_cancel.setOnClickListener(new View.OnClickListener(){
			    public void onClick(View v){
				success_dialog.dismiss();
				SketchwareUtil.showMessage(getApplicationContext(), "Chat through WhatsApp");
			}});
		success_dialog.show();
		_bounce(s_header);
	}
	...
	private void _call_dialog () {
		final AlertDialog call_dialog = new AlertDialog.Builder(MainActivity.this).create();
		LayoutInflater inflater = getLayoutInflater();
	...
	private void _info_dialog () {
		final AlertDialog info_dialog = new AlertDialog.Builder(MainActivity.this).create();
		LayoutInflater inflater = getLayoutInflater();
		...
		Button i_ok = (Button) convertView.findViewById(R.id.info_okay_button);
		
		Button i_cancel = (Button) convertView.findViewById(R.id.info_cancel_button);
	...
	private void _fab4 () {
		LinearLayout fab4 = (LinearLayout)bg.findViewById(R.id.linear9);
		
		_SetRadiusToView(fab4, (int)getDip(20), "#3770FD");
		
		fab4.setElevation(8f);
	...
	private void _meeting_dialog () {
		final AlertDialog meeting_dialog = new AlertDialog.Builder(MainActivity.this).create();
		LayoutInflater inflater = getLayoutInflater();
		
		View convertView = (View) inflater.inflate(R.layout.meeting_dialog, null);
		meeting_dialog.setView(convertView);
		
		meeting_dialog.requestWindowFeature(Window.FEATURE_NO_TITLE);  meeting_dialog.getWindow().setBackgroundDrawable(new android.graphics.drawable.ColorDrawable(Color.TRANSPARENT));
		...
		Button i_ok = (Button) convertView.findViewById(R.id.meeting_okay_button);
		
		Button i_cancel = (Button) convertView.findViewById(R.id.meeting_cxd_button);
		...
		i_ok.setOnClickListener(new View.OnClickListener(){
			    public void onClick(View v){
				meeting_dialog.dismiss();
				//Check if jitsi meet is installed
				boolean isAppInstalled = appInstalledOrNot("org.jitsi.meeu");
				if (isAppInstalled) {
					//Open jitsi meet
					Intent launchIntent = getPackageManager().getLaunchIntentForPackage("org.jitsi.meeu"); startActivity(launchIntent);
				}
				else {
					//Download jitsi meet
					install.setAction(Intent.ACTION_INSTALL_PACKAGE);
					install.setData(Uri.parse("https://drive.google.com/file/d/1J1m6IjPES8bhez9i_epojXD6PzWMSHb7/view?usp=drivesdk"));
